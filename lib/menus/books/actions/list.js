...
// função que exibe a lista de livro da linha 76, não usei o pretty
...
// 1* pegar o nome do livro que o usuario digitar
...
// preparando para exibir as informações;
...
const showBooksList = async (goBackToBooksMenu, nextLink) => {
  try {
    ...
    const pageLink = 'https://www.anapioficeandfire.com/api/books?name=';
