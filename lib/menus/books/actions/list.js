...
const handleUserChoice = (userChoice, { goBackToBooksMenu, showBooksList, links, url }) => {
...
const showBooksList = async (goBackToBooksMenu, pageLink) => {
  ...
  return handleUserChoice(userChoice, { goBackToBooksMenu, showBooksList, links, url });
};
