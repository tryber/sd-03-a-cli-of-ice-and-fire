...
// FIRST_PAGE_LINK retorna apenas a base da requisão.
const FIRST_PAGE_LINK = 'https://www.anapioficeandfire.com/api/books';

const MENU_MAIN_MESSAGE = '[Listar Livros] - Digite o nome do livro para ver mais detalhes';

// Try catch para fazer as requisições.
...
// Essa função é a mais importante. Try catch para persquisar query com books digitado na pesquisa.
