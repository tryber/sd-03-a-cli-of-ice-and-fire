 ...
 */
const handleUserChoice = (userChoice, { goBackToCharactersMenu: goBackToBookMenu, showCharactersList, links }) => {
  ...
  if (userChoice === 'next' || userChoice === 'prev') {
     ...
     */
    return showCharactersList(goBackToBookMenu, links[userChoice]);
  }
