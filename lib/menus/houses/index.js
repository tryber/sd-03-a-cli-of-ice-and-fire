...
const showHouseMenu = async (goBackToMenu) => {
  const action = await showMenuOptions({
    message: 'Menu -- Escolha uma ação',
    choices: [
  ...
  const goBackToCharactersMenu = () => showCharactersMenu(goBackToMenu);
...
module.exports = { run: showHouseMenu };
