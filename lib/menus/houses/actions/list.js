...
const removePropertiesFromHouses = ({ books, povBooks, ...house }) =>
  removeEmptyProperties(house);

const createChoiceFromHouses = (house) => ({
  /* Uma personagem/casa pode não ter nome. Nesses casos, a API traz a propriedade `alias`,
         que é o que usamos aqui para mostrar a personagem/casa na lista */
